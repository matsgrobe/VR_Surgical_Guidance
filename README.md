...
* **Dwell-Time Success Logic:** To ensure surgical stability, the system requires the instrument tip to stay within a 5 cm threshold for **1.5 seconds** before a target is marked as successful.
